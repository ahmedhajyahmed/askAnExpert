...
import { HistoriqueAppelComponent } from 'app/entities/historique-appel/historique-appel.component';
...
describe('Component Tests', () => {
    describe('HistoriqueAppel Management Component', () => {
        let comp: HistoriqueAppelComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HistoriqueAppelComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.historiqueAppels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
